...
__all__ = [
    ...
    'DISPID_SVGetVoices', 'IInternetSecurityMgrSite', 'SVP_8',
    'SAFT48kHz8BitMono', 'DISPID_SPIGetText', 'DISPID_SAFGuid',
    'SPCT_SUB_COMMAND', 'SITooFast', 'ISpeechXMLRecoResult',
    'SPVOICESTATUS', 'SpeechInterference', 'DISPID_SLPType',
    'SGPronounciation', 'SPRS_INACTIVE', 'SPPS_Unknown', 'SGDisplay',
    'DISPID_SRCERecognizerStateChange', 'ISpResourceManager',
    'SPXRO_SML', 'SPEI_ACTIVE_CATEGORY_CHANGED',
    'DISPID_SRCEPropertyStringChange',
    'DISPID_SRSCurrentStreamPosition', 'SVSFIsFilename', 'SPRULE',
    'DISPID_SRIsUISupported', 'SpeechAudioVolume',
    'eLEXTYPE_PRIVATE10', 'DISPID_SpeechWaveFormatEx',
    'SREHypothesis', 'DISPID_SPPChildren',
    ...
    'SRESoundStart', 'SAFTADPCM_11kHzStereo', 'SRSInactive',
    'SGSExclusive', 'DISPID_SVResume', 'SpeechGrammarTagDictation',
    'SVPNormal', 'DISPID_SRGCmdLoadFromFile', 'SP_VISEME_5',
    'ISpeechLexiconWord', 'SPCT_DICTATION', 'DISPID_SRRTLength',
    'SWPKnownWordPronounceable', 'DISPID_SGRs_NewEnum',
    'SPPS_Interjection', 'SAFT24kHz16BitMono', 'SGSEnabled',
    'DISPID_SRCRetainedAudioFormat', 'SREStreamStart',
    'SPEI_VOICE_CHANGE', 'DISPID_SRCBookmark', 'DISPID_SGRsItem',
    'DISPID_SRCESoundStart', 'DISPID_SpeechRecoResultTimes',
    'DISPID_SBSWrite', 'DISPID_SLWType', 'DISPID_SRGCommit',
    'DISPID_SPRuleParent', '_ISpeechRecoContextEvents', 'SVPOver',
    'SAFT24kHz8BitMono', 'ISpSerializeState', 'SPSHORTCUTPAIRLIST',
    'ISpRecognizer3', 'DISPID_SVRate', 'ISpShortcut',
    'DISPID_SRCAudioInInterferenceStatus', 'SREInterference',
    'SPEI_PROPERTY_NUM_CHANGE', 'SpeechDiscardType',
    'Speech_Max_Word_Length', 'SPEI_SR_AUDIO_LEVEL', 'ISpAudio',
    'SRTEmulated', 'ISpeechPhraseElements', 'DISPID_SOTDisplayUI',
    'DISPID_SRCEInterference', 'DISPID_SAVolume', 'eWORDTYPE_DELETED',
    'DISPID_SRGRules', 'SPCONTEXTSTATE', 'SAFTADPCM_8kHzMono',
    'DISPID_SGRSTsItem', 'SITooLoud', 'DISPID_SVEEnginePrivate',
    'SVSFPurgeBeforeSpeak', 'DISPID_SPIElements',
    'DISPID_SRCreateRecoContext', 'DISPID_SRSetPropertyString',
    'SpeechRecognitionType', 'DISPID_SpeechPhraseRules',
    'SAFT12kHz8BitMono', 'SPADAPTATIONRELEVANCE', 'SDKLCurrentUser',
    'SpeechUserTraining', 'SpeechTokenContext', 'SVEViseme',
    'SGRSTTDictation', 'SVEAudioLevel', 'DISPID_SGRsCount',
    'SPRS_ACTIVE_WITH_AUTO_PAUSE', 'SVSFNLPMask', 'DISPID_SDKOpenKey',
    'DISPID_SPPId', 'ISpXMLRecoResult', 'SPSNotOverriden',
    'SpObjectToken', 'SASClosed', 'SPEI_END_SR_STREAM',
    'DISPID_SVEBookmark', 'SREAdaptation', 'DISPID_SGRSTType',
    'DISPID_SRRTimes', 'DISPID_SDKDeleteKey', 'eLEXTYPE_PRIVATE16',
    'DISPID_SpeechPhraseBuilder', 'ISpObjectTokenCategory',
    'DISPID_SPEDisplayText', 'DISPID_SPPConfidence',
    'eLEXTYPE_RESERVED4', 'ISpRecoResult', 'DISPID_SRState',
    'SAFTCCITT_ALaw_22kHzStereo', 'DISPID_SpeechObjectTokenCategory',
    'UINT_PTR', 'SVP_1', 'SPINTERFERENCE_TOOLOUD', 'SPSEMANTICFORMAT',
    ...
    'DISPID_SVEVoiceChange', 'SITooQuiet', 'SpeechRuleState',
    'SPEI_UNDEFINED', 'SVSFParseSsml', 'SLODynamic',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN',
    'DISPID_SVGetAudioOutputs', 'DISPID_SPPsCount',
    'SPEI_FALSE_RECOGNITION', 'SPBO_TIME_UNITS', 'SDTAlternates',
    'SAFT8kHz16BitMono', 'DISPID_SAEventHandle',
    'DISPID_SRCCmdMaxAlternates', 'DISPID_SRGetRecognizers',
    'DISPID_SRRTStreamTime', 'SVEPhoneme', 'SAFTExtendedAudioFormat',
    'SPPROPERTYINFO', 'SPVPRI_NORMAL', 'SVP_4',
    'ISpeechPhraseAlternate', 'DISPID_SOTRemove',
    'eLEXTYPE_PRIVATE19', 'SPDATAKEYLOCATION', 'SPEI_PHRASE_START',
    'ISpVoice', 'LONG_PTR', 'SPPHRASEELEMENT', 'SVP_9',
    'ISpeechAudioBufferInfo', 'tagSPTEXTSELECTIONINFO',
    'SVESentenceBoundary', 'DISPID_SVSVisemeId', 'ISpeechLexicon',
    'DISPID_SPIReplacements', 'SVF_None', 'DISPID_SLWPronunciations',
    'DISPID_SRRecognizer', 'SECFIgnoreKanaType',
    'ISpeechCustomStream', 'SAFT32kHz8BitStereo', 'DISPID_SLPLangId',
    'SRSEDone', 'SVP_12', 'SVSFParseMask', 'SpStreamFormatConverter',
    'SSSPTRelativeToCurrentPosition', 'DISPID_SASFreeBufferSpace',
    'DISPID_SPEEngineConfidence', 'SpeechGrammarTagWildcard',
    'DISPID_SLPs_NewEnum', 'tagSTATSTG', 'SpeechRunState',
    'DISPID_SpeechDataKey', 'SPEI_HYPOTHESIS', 'SREPhraseStart',
    'STSF_AppData', 'SPWORDPRONUNCIATION',
    'DISPID_SRCERecognitionForOtherContext', 'ISpStreamFormat',
    'SASStop', 'SDA_No_Trailing_Space', 'ISpRecoGrammar',
    'DISPID_SLWsCount', 'ISpMMSysAudio', 'SPLO_DYNAMIC',
    'DISPID_SVSLastStreamNumberQueued', 'DISPID_SVSLastResult',
    'DISPID_SPEs_NewEnum', 'SpeechVoiceEvents',
    'SpeechGrammarWordType', 'DISPID_SRGId', 'SECFEmulateResult',
    'DISPID_SVSInputWordLength', 'SECFIgnoreCase', 'SPSHT_Unknown',
    'SpResourceManager', 'DISPID_SpeechVoiceStatus', 'SPSFunction',
    'DISPID_SASState', 'DISPID_SAFSetWaveFormatEx',
    'eLEXTYPE_RESERVED10', 'SSSPTRelativeToStart', 'DISPID_SPRText',
    'SVSFIsNotXML', 'Speech_Max_Pron_Length', 'DISPID_SGRClear',
    'DISPID_SPEActualConfidence', 'SPEI_PROPERTY_STRING_CHANGE',
    'DISPID_SVEventInterests', 'ISpNotifySink', 'SPFILEMODE',
    'SRSActive', 'SPEI_RECOGNITION', 'SBONone',
    'SPXRO_Alternates_SML', 'DISPID_SLPsItem', 'SPEI_SOUND_END',
    ...
    'DISPID_SFSClose', 'SAFTCCITT_ALaw_44kHzStereo', 'SVP_13',
    'DISPID_SpeechGrammarRuleState', 'SPWF_INPUT', 'ISpRecoGrammar2',
    'SPRECOCONTEXTSTATUS', 'SpeechTokenValueCLSID', 'SGRSTTRule',
    'DISPID_SpeechLexicon', 'DISPID_SVAlertBoundary',
    'DISPID_SVESentenceBoundary', 'SpeechVisemeFeature',
    'ISpeechRecoContext', 'ISpeechGrammarRuleStateTransition',
    'SINoSignal', 'SPPS_NotOverriden', 'SPEVENT', 'SGSDisabled',
    'SAFTCCITT_ALaw_44kHzMono', 'SVP_16', 'DISPID_SRCEPhraseStart',
    'SPEI_MIN_TTS', 'SPCS_DISABLED', 'SPWORDPRONOUNCEABLE',
    'DISPID_SGRSTRule', 'SPINTERFERENCE_NOSIGNAL', 'SPBO_PAUSE',
    'SRTSMLTimeout', 'DISPID_SPPFirstElement', 'ISpeechWaveFormatEx',
    'ISpeechPhraseInfo', 'SPWP_KNOWN_WORD_PRONOUNCEABLE',
    'DISPID_SPIRule', 'SPINTERFERENCE_TOOSLOW',
    'DISPID_SADefaultFormat', 'SREPrivate', 'SVEPrivate',
    'SSTTDictation', 'DISPID_SGRSTNextState', 'SAFTNoAssignedFormat',
    'DISPID_SpeechMMSysAudio', 'eWORDTYPE_ADDED',
    'Speech_Default_Weight', 'DISPID_SpeechPhraseRule', 'SFTSREngine',
    'DISPID_SLAddPronunciation', 'SPSTREAMFORMATTYPE',
    'DISPID_SGRSAddSpecialTransition', 'DISPID_SLGetGenerationChange',
    'SVSFParseSapi', 'DISPID_SRCEHypothesis', 'SECFIgnoreWidth',
    'SVEEndInputStream', 'DISPID_SGRsCommitAndSave',
    'SWPUnknownWordPronounceable', 'SpMMAudioOut', 'SPWT_LEXICAL',
    'SAFTText', 'SPRST_INACTIVE_WITH_PURGE',
    'DISPID_SREmulateRecognition', 'SP_VISEME_1',
    'DISPID_SRGDictationSetState', 'SAFTADPCM_22kHzStereo',
    'DISPID_SRRAudio', 'IEnumSpObjectTokens', 'SDTProperty',
    'ISpeechLexiconPronunciation', 'SpVoice', 'SPRULESTATE',
    'SPRST_ACTIVE_ALWAYS', 'SPDKL_LocalMachine', 'SVF_Stressed',
    'ISpeechRecoResultTimes', 'DISPID_SpeechPhraseElement',
    'DISPID_SLGetWords', 'SP_VISEME_9', 'SAFT11kHz16BitMono',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS',
    'DISPID_SAFGetWaveFormatEx', 'SPVPRIORITY', 'SVP_14', 'SPSVerb',
    'SpeechTokenKeyUI', 'SRAInterpreter', 'SSFMOpenForRead',
    'SPAR_Medium', 'SRCS_Disabled', 'DISPID_SpeechFileStream',
    'SPINTERFERENCE', 'SPEI_RECO_STATE_CHANGE', 'SP_VISEME_11',
    'DISPID_SpeechGrammarRuleStateTransitions', 'SPGS_DISABLED',
    'SLTUser', 'SAFT22kHz16BitMono', 'SpeechSpecialTransitionType',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002', 'DISPID_SLWsItem',
    'DISPID_SpeechPhraseReplacements', 'IEnumString', 'SPAS_PAUSE',
    'DISPID_SRCEventInterests', 'SPEI_VISEME',
    'SAFTCCITT_uLaw_11kHzMono', 'DISPID_SVSLastBookmarkId',
    'DISPID_SLPSymbolic', 'DISPID_SRCSetAdaptationData',
    'DISPID_SDKSetLongValue', 'SAFTCCITT_ALaw_11kHzMono',
    'SRERequestUI', 'DISPID_SpeechAudio',
    'DISPID_SpeechGrammarRuleStateTransition', 'eLEXTYPE_PRIVATE17',
    'SVEVoiceChange', 'SPINTERFERENCE_LATENCY_TRUNCATE_END',
    'DISPID_SABIBufferSize', 'ISpeechRecognizerStatus', 'SVP_2',
    'SPGRAMMARSTATE', 'ISpeechPhraseProperty', 'ISpeechBaseStream',
    'SRAONone', 'SRSActiveAlways', 'ISpeechPhraseProperties',
    'SpeechStreamFileMode', 'DISPID_SPEAudioStreamOffset',
    'DISPID_SVVolume', 'SVSFVoiceMask', 'DISPID_SpeechRecoContext',
    'DISPID_SPEAudioTimeOffset', 'DISPID_SPRuleFirstElement',
    'SAFT24kHz8BitStereo', 'DISPID_SMSGetData',
    'DISPID_SpeechObjectTokens', 'SREAllEvents',
    'DISPID_SVSPhonemeId', 'SPFM_OPEN_READONLY', 'SPWT_DISPLAY',
    'SRAImport', 'SpeechPropertyHighConfidenceThreshold',
    'DISPID_SPAsCount', 'eLEXTYPE_PRIVATE7',
    'SpeechRetainedAudioOptions',
    'SpeechPropertyNormalConfidenceThreshold',
    'DISPID_SASNonBlockingIO', 'STCInprocHandler', 'SVSFIsXML',
    'SVP_21', 'ISpEventSink', 'eLEXTYPE_RESERVED6', 'SPPHRASERULE',
    'eLEXTYPE_PRIVATE2', 'SPINTERFERENCE_TOOQUIET', 'SVP_11',
    'DISPID_SPRFirstElement', 'SPPS_Verb',
    'DISPID_SVSpeakCompleteEvent', 'SpeechCategoryRecognizers',
    'DISPID_SWFEBitsPerSample', 'STSF_LocalAppData',
    'DISPID_SABufferNotifySize', 'SpeechLexiconType',
    'DISPID_SOTSetId', 'DISPID_SPAsItem', 'SPINTERFERENCE_NOISE',
    'SAFT8kHz8BitStereo', 'DISPID_SPIGetDisplayAttributes',
    'SPVPRI_OVER', 'ISpeechDataKey', 'DISPID_SMSALineId',
    'SDA_One_Trailing_Space', 'SVSFParseAutodetect',
    'STCRemoteServer', 'ISpeechPhraseReplacement',
    'SpeechCategoryRecoProfiles', 'SPEI_RESERVED6', 'SBOPause',
    'SPEI_RESERVED3', 'SAFTADPCM_11kHzMono', 'DISPID_SPEsItem',
    'Speech_StreamPos_RealTime', 'SPPS_RESERVED1', 'SSTTTextBuffer',
    'DISPID_SDKGetlongValue', 'DISPID_SRCRecognizer', 'SGRSTTEpsilon',
    'SRESoundEnd', 'SpPhoneticAlphabetConverter',
    'SPSERIALIZEDPHRASE', 'DISPID_SPPParent', 'SPEI_MAX_TTS',
    'SP_VISEME_4', 'DISPID_SGRId', 'DISPID_SABIEventBias',
    'eLEXTYPE_PRIVATE5', 'DISPID_SRCVoicePurgeEvent',
    'DISPID_SRGSetTextSelection', 'DISPID_SRSetPropertyNumber',
    'SPLO_STATIC', 'SPWF_SRENGINE', 'SpeechAddRemoveWord',
    'DISPID_SGRSAddRuleTransition', 'DISPID_SRGetPropertyNumber',
    'SGDSInactive', 'SAFT16kHz8BitMono', 'SpeechVisemeType',
    'SDTReplacement', 'eLEXTYPE_PRIVATE4', 'SPRECOSTATE',
    'SPSHORTCUTTYPE', 'SpNotifyTranslator', 'SPFM_CREATE',
    'DISPID_SRGState', 'DISPID_SpeechRecognizer', 'DISPID_SRCState',
    'SAFTCCITT_uLaw_8kHzStereo', 'SpeechCategoryPhoneConverters',
    'DISPID_SVSpeakStream', 'DISPID_SCSBaseStream', 'DISPID_SOTCId',
    'DISPID_SpeechXMLRecoResult', 'ISpStream',
    'DISPID_SPRules_NewEnum', 'SVP_6', 'SpInProcRecoContext',
    'ISpeechTextSelectionInformation', 'eLEXTYPE_PRIVATE18',
    'SpeechBookmarkOptions', 'eLEXTYPE_RESERVED9',
    'DISPID_SPEAudioSizeTime', 'DISPID_SPPName', 'SRADynamic',
    'SPPS_RESERVED3', 'SPEI_WORD_BOUNDARY', 'SPSMF_UPS',
    'SAFT44kHz16BitStereo', 'SPLEXICONTYPE', 'DISPID_SVEViseme',
    'DISPID_SDKSetBinaryValue', 'SPWORDPRONUNCIATIONLIST',
    'DISPID_SGRAttributes', 'ISpLexicon', 'ISpNotifySource',
    'SPEI_INTERFERENCE', 'DISPID_SRCEFalseRecognition',
    'SAFTADPCM_8kHzStereo', 'SPBOOKMARKOPTIONS', 'SDTAudio',
    'SpMMAudioIn', 'DISPID_SLRemovePronunciationByPhoneIds',
    'SpeechWordType', 'SPAO_RETAIN_AUDIO', 'DISPID_SDKEnumKeys',
    'DISPID_SPERetainedStreamOffset', 'SPVPRI_ALERT',
    'DISPID_SPPBRestorePhraseFromMemory', 'ISpRecoContext2',
    'SAFT11kHz8BitMono', 'DISPID_SPRuleEngineConfidence',
    'DISPID_SOTCDefault', 'SPPS_Modifier', 'DISPID_SRGRecoContext',
    'ISpStreamFormatConverter', 'ISpeechPhoneConverter',
    'DISPID_SPERetainedSizeBytes', 'DISPID_SVSInputWordPosition',
    'WAVEFORMATEX', 'SRCS_Enabled', 'eLEXTYPE_VENDORLEXICON',
    'SPEI_PHONEME', 'SpSharedRecoContext', 'ISpeechPhraseRules',
    'SpeechEngineConfidence', 'DISPID_SABufferInfo', 'SpShortcut',
    'SREPropertyStringChange', 'SASPause', 'SPDKL_CurrentUser',
    'ISpeechFileStream', 'SPBO_NONE', 'SPAUDIOSTATE', 'SPLOADOPTIONS',
    'DISPID_SDKDeleteValue', 'eLEXTYPE_PRIVATE13', 'SPPS_RESERVED2',
    'ISpDataKey', 'DISPID_SPRulesItem', 'SpeechVoiceSpeakFlags',
    'SDTDisplayText', 'SRATopLevel', 'DISPID_SRCEAudioLevel',
    'SPGS_EXCLUSIVE', 'SPCT_SUB_DICTATION', 'ISpObjectToken',
    'SGLexical', 'SpMMAudioEnum', 'DISPID_SGRAddState',
    'SPSMF_SAPI_PROPERTIES', 'SREStreamEnd',
    ...
    'DISPID_SDKSetStringValue', 'SPWORD', 'SpeechWordPronounceable',
    'SPSModifier', 'eLEXTYPE_PRIVATE12', 'SPEI_SR_PRIVATE',
    'ISpeechVoice', 'DISPID_SPIProperties', 'SP_VISEME_8',
    'SpAudioFormat', 'SAFT22kHz16BitStereo', 'SECFNoSpecialChars',
    'ISpeechRecoResult2', 'DISPID_SGRSTPropertyName',
    'ISpeechObjectToken', 'SPPS_SuppressWord',
    'DISPID_SVSInputSentencePosition', 'SPEI_MAX_SR',
    'SpeechCategoryVoices', '__MIDL_IWinTypes_0009',
    'SVSFUnusedFlags', 'DISPID_SRSAudioStatus', 'SLTApp',
    'DISPID_SRCEBookmark', 'DISPID_SGRInitialState',
    'DISPID_SRProfile', 'SRERecoOtherContext', 'SPEI_TTS_AUDIO_LEVEL',
    'SPFM_CREATE_ALWAYS', 'SP_VISEME_13', 'SRADefaultToActive',
    'SAFT32kHz16BitStereo', 'SPWT_LEXICAL_NO_SPECIAL_CHARS',
    'DISPID_SpeechGrammarRule', 'SPAUDIOBUFFERINFO',
    'SAFT22kHz8BitMono', 'SGLexicalNoSpecialChars', 'DISPID_SBSSeek',
    'SVP_3', 'SpeechVoiceSkipTypeSentence', 'DISPID_SGRSTs_NewEnum',
    'DISPIDSPTSI_ActiveOffset', 'SAFT12kHz16BitMono',
    'DISPID_SRIsShared', 'SpNullPhoneConverter', 'SVP_17',
    'SpeechRuleAttributes', 'SAFT16kHz8BitStereo',
    'DISPID_SPIAudioSizeTime', 'DISPID_SPRuleChildren',
    'STCInprocServer', 'DISPID_SRGCmdLoadFromObject',
    'SVEWordBoundary', 'DISPID_SPRuleName',
    'DISPID_SpeechPhraseProperty', 'SPINTERFERENCE_NONE', 'SVP_0',
    'ISpPhoneticAlphabetConverter', 'SVSFlagsAsync',
    'SpTextSelectionInformation', 'DISPID_SWFEChannels',
    'DISPID_SVGetProfiles', 'DISPID_SVEAudioLevel', 'SP_VISEME_19',
    'SpeechPartOfSpeech', 'SSFMCreateForWrite',
    'DISPID_SRCCreateGrammar', 'SP_VISEME_14',
    'DISPID_SRRRecoContext', 'tagSPPROPERTYINFO', 'SPPS_Function',
    'DISPID_SVPriority', 'SPEI_END_INPUT_STREAM',
    'SPWT_PRONUNCIATION', 'SpeechRecoProfileProperties',
    'SPSMF_SRGS_SAPIPROPERTIES', 'SPPS_Noncontent',
    'DISPID_SpeechRecoContextEvents', 'SAFT16kHz16BitMono',
    'SITooSlow', 'SWTDeleted', 'ISpPhrase', 'SRERecognition',
    'SPBINARYGRAMMAR', 'SAFTCCITT_uLaw_44kHzMono', 'SPCT_COMMAND',
    'DISPID_SPIStartTime', 'DISPID_SVAudioOutput',
    'DISPID_SpeechAudioFormat', 'ISpeechAudioFormat', 'SPCS_ENABLED',
    'SpeechCategoryAppLexicons', 'DISPID_SVEWord', 'SSTTWildcard',
    'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE', 'DISPID_SDKGetBinaryValue',
    'DISPID_SPIEnginePrivateData', 'SWTAdded', 'eLEXTYPE_PRIVATE6',
    'DISPID_SRCPause', 'ISpRecoCategory', 'STCAll',
    'SpPhraseInfoBuilder', 'SGRSTTWildcard', 'DISPID_SPRsCount',
    'DISPID_SGRAddResource', 'SpeechGrammarTagUnlimitedDictation',
    'SAFTCCITT_uLaw_8kHzMono', 'SPSNoun', 'DISPID_SFSOpen',
    'SpeechAudioFormatGUIDText', 'SPPHRASEREPLACEMENT',
    'DISPID_SRRGetXMLResult', 'SREPropertyNumChange', 'SVP_18',
    'DISPID_SVSkip', 'DISPID_SVSInputSentenceLength',
    'DISPID_SLPsCount', 'SGDSActiveWithAutoPause', 'SDTRule',
    'SVSFPersistXML', 'SPCATEGORYTYPE', 'SPRECOGNIZERSTATUS',
    'DISPID_SRCERequestUI', 'SECHighConfidence', 'SpeechAudioState',
    ...
    '_RemotableHandle', 'DISPID_SVVoice', 'SREBookmark',
    'SpeechVoiceCategoryTTSRate', 'SAFTCCITT_uLaw_22kHzMono',
    'SPSEMANTICERRORINFO', 'SASRun', 'DISPID_SRRAlternates',
    'DISPID_SASCurrentSeekPosition', 'SpCustomStream',
    'SPEI_START_INPUT_STREAM', 'ISpeechRecoGrammar', 'SP_VISEME_10',
    'SPXMLRESULTOPTIONS', 'DISPID_SRCEEndStream',
    'DISPID_SGRSTPropertyId', 'SPEI_ADAPTATION', 'DISPID_SOTDataKey',
    'SREStateChange', 'ISpPhoneticAlphabetSelection',
    'DISPID_SRRPhraseInfo', 'DISPID_SDKEnumValues',
    'DISPID_SLPPhoneIds', 'DISPID_SRCCreateResultFromMemory',
    'DISPID_SOTId', 'SPEI_TTS_BOOKMARK', 'SDTLexicalForm',
    'DISPID_SOTs_NewEnum', 'SAFT48kHz8BitStereo',
    'DISPID_SRSSupportedLanguages', 'eLEXTYPE_PRIVATE11',
    'SPWORDTYPE', 'SVP_10', 'SpFileStream', 'STCLocalServer',
    'SP_VISEME_20', 'SAFT24kHz16BitStereo', 'SAFT44kHz8BitMono',
    'eLEXTYPE_PRIVATE9', 'DISPID_SPRulesCount', 'STSF_FlagCreate',
    'SAFT48kHz16BitStereo', 'DISPID_SRGCmdLoadFromResource',
    'SpeechMicTraining', 'ISpProperties',
    ...
    'SDA_Consume_Leading_Spaces', 'SVP_15', 'SVF_Emphasis',
    'eLEXTYPE_USER', 'ISpRecognizer', 'SPAUDIOSTATUS',
    'SpeechVoicePriority', 'SPBO_AHEAD', 'DISPID_SVGetAudioInputs',
    'DISPID_SPAStartElementInResult', 'DISPID_SGRsFindRule',
    'DISPID_SPPsItem', 'SpeechDictationTopicSpelling',
    'DISPID_SVEStreamStart', 'SAFTNonStandardFormat', 'SPRS_ACTIVE',
    'SRTStandard', 'SPSHT_EMAIL', 'SVEAllEvents',
    'DISPID_SRGetPropertyString', 'SPPARTOFSPEECH',
    'SAFT11kHz8BitStereo', 'DISPIDSPTSI_ActiveLength', 'SPVISEMES',
    'DISPIDSPTSI_SelectionLength', 'DISPID_SpeechLexiconWords',
    'SP_VISEME_16', 'SSFMCreate', 'SpeechRecoContextState',
    'SPDKL_CurrentConfig', 'SpMemoryStream',
    ...
    'SpInprocRecognizer', 'ISpeechAudio', 'DISPID_SOTCGetDataKey',
    'SVEBookmark', 'SAFTADPCM_44kHzStereo', 'SpeechRecoEvents',
    'DISPID_SLWs_NewEnum', 'DISPID_SpeechPhraseReplacement',
    'DISPID_SPISaveToMemory', 'DISPID_SGRSTsCount',
    'DISPID_SRRSpeakAudio', 'SAFTCCITT_ALaw_8kHzMono',
    'SpPhoneConverter', 'SGRSTTTextBuffer',
    'SAFTCCITT_uLaw_44kHzStereo', 'SPGS_ENABLED', 'SPGRAMMARWORDTYPE',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'SAFTGSM610_8kHzMono', 'SpeechAudioFormatGUIDWave',
    'DISPID_SRDisplayUI', 'DISPID_SPPNumberOfElements',
    'SDTPronunciation', 'SPPS_RESERVED4',
    'ISpeechGrammarRuleStateTransitions', 'DISPID_SGRName',
    'DISPID_SVSRunningState', 'SP_VISEME_0', 'DISPID_SPPs_NewEnum',
    'DISPID_SPIAudioSizeBytes', 'DISPID_SAFType', 'SRSEIsSpeaking',
    'DISPID_SPRuleConfidence', 'SREFalseRecognition',
    'SPRST_NUM_STATES', 'SPEI_RESERVED1', 'SVP_5', 'DISPID_SVStatus',
    'DISPID_SRGIsPronounceable', 'SpeechRecognizerState',
    'eLEXTYPE_PRIVATE15', 'ISpeechVoiceStatus',
    'DISPID_SpeechLexiconProns', 'SPAS_CLOSED', 'ISequentialStream',
    'SpeechGrammarRuleStateTransitionType', 'eLEXTYPE_PRIVATE14',
    'SAFT32kHz16BitMono', 'SP_VISEME_15', 'DISPID_SPEPronunciation',
    'SPPS_LMA', 'SVEStartInputStream',
    'DISPID_SpeechRecognizerStatus', 'SVPAlert',
    'eLEXTYPE_USER_SHORTCUT', 'DISPID_SDKCreateKey',
    'SAFT32kHz8BitMono', '_ISpeechVoiceEvents', 'DISPID_SBSRead',
    'SpeechPropertyAdaptationOn', 'DISPID_SPCPhoneToId',
    'DISPID_SPEAudioSizeBytes', 'SP_VISEME_21', 'SVSFNLPSpeakPunc',
    '_SPAUDIOSTATE', 'DISPID_SMSAMMHandle',
    'DISPID_SpeechPhraseProperties', 'ISpEventSource',
    'SAFTGSM610_44kHzMono', 'ISpGrammarBuilder',
    'DISPID_SpeechPhraseElements', 'DISPID_SGRSRule',
    'DISPID_SpeechRecoResult', 'DISPID_SGRsDynamic',
    'eLEXTYPE_PRIVATE20', 'DISPID_SRCResume', 'ISpeechResourceLoader',
    'ISpeechPhraseInfoBuilder', 'DISPID_SVSpeak',
    'SpeechEngineProperties', 'DISPID_SRCVoice', 'DISPID_SMSSetData',
    'ISpeechMMSysAudio', 'IStream', 'DISPID_SVPause',
    'SpeechGrammarState', 'DISPID_SOTMatchesAttributes',
    'DISPID_SPIRetainedSizeBytes', 'SPFM_NUM_MODES',
    'SAFT12kHz8BitStereo', 'SRTReSent', 'SPEI_SR_BOOKMARK',
    'DISPID_SPRuleId', 'SP_VISEME_6', 'SpeechTokenKeyAttributes',
    'SPSHT_NotOverriden', 'SpeechRegistryUserRoot',
    ...
    'SAFTGSM610_22kHzMono', 'DISPID_SVEPhoneme', 'SSSPTRelativeToEnd',
    'ISpeechObjectTokens', 'SPRECORESULTTIMES', 'SAFTADPCM_22kHzMono',
    'DISPID_SPAs_NewEnum', 'DISPID_SLPPartOfSpeech',
    'SPPHRASEPROPERTY', 'SPSUnknown', 'DISPID_SOTCreateInstance',
    'SPSERIALIZEDRESULT', 'SPWAVEFORMATTYPE', 'SPAS_RUN', 'SpStream',
    'DISPID_SpeechLexiconWord', 'SGDSActive', 'SPAR_High',
    'DISPID_SLAddPronunciationByPhoneIds', 'SVSFDefault',
    'ISpPhoneConverter', 'ISpRecoContext', 'DISPID_SRRSaveToMemory',
    'SpSharedRecognizer', 'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C',
    'DISPID_SOTCSetId', 'DISPID_SOTCEnumerateTokens', 'SP_VISEME_18',
    'eLEXTYPE_PRIVATE8', 'DISPID_SPRsItem',
    'DISPID_SPPEngineConfidence', 'SPWP_UNKNOWN_WORD_PRONOUNCEABLE',
    'SAFT48kHz16BitMono', 'SpeechLoadOption', 'DISPID_SRSClsidEngine',
    'SPAR_Unknown', 'SRSInactiveWithPurge',
    'DISPID_SpeechAudioBufferInfo', 'SAFT44kHz8BitStereo',
    'DISPID_SpeechPhraseAlternates', 'DISPID_SRGCmdLoadFromMemory',
    'SPAS_STOP', 'DISPID_SRRTOffsetFromStart', 'SPEI_REQUEST_UI',
    'eLEXTYPE_PRIVATE1', 'DISPID_SpeechVoiceEvent', 'SPEVENTENUM',
    'ISpeechLexiconWords', 'SPAR_Low', 'SpLexicon',
    'DISPID_SWFEFormatTag', 'ISpeechPhraseRule', 'SPWORDLIST',
    'DISPID_SOTsItem', 'SINoise', 'DISPID_SPILanguageId',
    'SAFTCCITT_ALaw_11kHzStereo', 'SpeechDataKeyLocation',
    'ISpeechRecoResult', 'DISPID_SpeechObjectToken',
    'DISPID_SPCLangId', 'SPEVENTSOURCEINFO', 'SPINTERFERENCE_TOOFAST',
    'DISPID_SGRSTWeight',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'SPEI_START_SR_STREAM', 'SPAO_NONE', 'SPEI_RESERVED2',
    'SpeechDisplayAttributes', 'SpeechPropertyResourceUsage',
    'DISPID_SBSFormat', 'DISPID_SRCEPropertyNumberChange',
    'SPRS_ACTIVE_USER_DELIMITED', 'DISPID_SRCEStartStream',
    'SAFTDefault', 'DISPID_SLWLangId', 'SpeechAllElements',
    'ISpeechObjectTokenCategory', 'DISPID_SPIAudioStreamPosition',
    'eLEXTYPE_MORPHOLOGY', 'ISpNotifyTranslator', 'DISPID_SGRsAdd',
    'SPRST_ACTIVE', 'Speech_StreamPos_Asap',
    'DISPID_SPANumberOfElementsInResult', 'ISpeechGrammarRuleState',
    'DISPID_SRGDictationLoad', 'SpeechPropertyResponseSpeed',
    'SGRSTTWord', 'DISPID_SVDisplayUI', 'SAFTCCITT_uLaw_11kHzStereo',
    'ISpeechRecognizer', 'SPEI_SOUND_START', 'SAFT16kHz16BitStereo',
    'SAFTADPCM_44kHzMono', 'DISPID_SPEDisplayAttributes',
    'SP_VISEME_17', 'SPDKL_DefaultLocation', 'SECNormalConfidence',
    'DISPID_SRStatus', 'DISPIDSPTSI_SelectionOffset',
    'DISPID_SGRSTText', 'SpCompressedLexicon', 'DISPID_SPCIdToPhone',
    'SPSHT_OTHER', 'SRAORetainAudio', 'SP_VISEME_2',
    'DISPID_SAStatus', 'SpeechFormatType', 'DISPID_SWFEExtraData',
    'DISPID_SRGSetWordSequenceData', 'DISPID_SpeechBaseStream',
    'SP_VISEME_3', 'DISPID_SRGCmdLoadFromProprietaryGrammar',
    'SDKLLocalMachine', 'SFTInput', 'SINone', 'SDKLDefaultLocation',
    'DISPID_SPEsCount', 'DISPID_SpeechAudioStatus', 'SP_VISEME_7',
    'DISPIDSPRG', 'DISPID_SVAudioOutputStream',
    'SpeechAudioFormatType', 'DISPID_SRCRequestedUIType',
    'DISPID_SGRsCommit', 'ISpeechPhraseAlternates',
    'SAFTCCITT_ALaw_8kHzStereo', 'SpWaveFormatEx',
    'IInternetSecurityManager', 'DISPID_SPPValue',
    'SAFTGSM610_11kHzMono', 'DISPID_SpeechLexiconPronunciation',
    'DISPID_SpeechGrammarRules', 'DISPID_SOTsCount',
    'DISPID_SRCEAdaptation', 'SREAudioLevel',
    'DISPID_SABIMinNotification', 'SPSSuppressWord',
    'SAFTCCITT_ALaw_22kHzMono', 'ISpPhraseAlt', 'DISPID_SOTCategory',
    'ISpeechLexiconPronunciations', 'DISPID_SRGReset', 'DISPIDSPTSI',
    'SPEI_RECO_OTHER_CONTEXT', 'ISpObjectWithToken',
    'ISpeechMemoryStream', 'DISPID_SRGetFormat', 'SAFT8kHz8BitMono',
    'ISpeechPhraseElement', 'SPSLMA', 'ISpeechRecoResultDispatch',
    'DISPID_SPERequiredConfidence', 'SPFM_OPEN_READWRITE',
    'DISPID_SRCERecognition', 'SDKLCurrentConfig',
    'SSFMOpenReadWrite', 'SRTAutopause', 'SRTExtendableParse',
    'DISPID_SpeechRecoResult2', 'SRAExport',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet', 'eLEXTYPE_PRIVATE3',
    'DISPID_SPRuleNumberOfElements', 'DISPID_SRSCurrentStreamNumber',
    'DISPID_SRGDictationUnload', 'SVP_7',
    'DISPID_SLGetPronunciations', 'DISPID_SGRSTPropertyValue',
    'DISPID_SVSLastBookmark', 'SPEI_MIN_SR', 'SPPS_Noun',
    'DISPID_SASCurrentDevicePosition', 'DISPID_SRRSetTextFeedback',
    'SPCT_SLEEP', 'DISPID_SVWaitUntilDone', 'DISPID_SMSADeviceId',
    'SPSHORTCUTPAIR', 'SPAUDIOOPTIONS', 'SpeechCategoryAudioOut',
    'DISPID_SPARecoResult', 'eLEXTYPE_RESERVED7',
    'DISPID_SpeechPhraseInfo', 'DISPID_SOTGetAttribute',
    'DISPID_SPRs_NewEnum', 'SVP_19', 'SpObjectTokenCategory',
    'DISPID_SpeechPhraseAlternate', 'SVP_20', 'SP_VISEME_12',
    'ISpRecognizer2', 'DISPID_SRGCmdSetRuleIdState', 'SECFDefault',
    'DISPID_SPACommit', 'SPEI_RESERVED5', 'DISPID_SASetState',
    'SLOStatic', 'SPSInterjection', 'SAFT44kHz16BitMono',
    'DISPID_SRGCmdSetRuleState', 'DISPID_SVIsUISupported', 'SDTAll',
